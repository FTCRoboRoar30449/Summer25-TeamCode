...
public class AutoRed extends OpMode {
    ...
    private final Pose pickup1Pose = new Pose(115, 25, Math.toRadians(180)); // First sample pickup
    private final Pose pickup2Pose = new Pose(115, 15, Math.toRadians(180)); // Second sample pickup
    private final Pose pickup3Pose = new Pose(115, 15, Math.toRadians(215)); // Third sample pickup
    private final Pose subPickupPose = new Pose(72, 40, Math.toRadians(90)); // Sub sample pickup
    private final Pose endGamePose = new Pose(72, 45, Math.toRadians(270)); // Parking position
